...
`<WoW>\_classic_beta_\Interface\AddOns\QuestTogetherForever\` and loaded after `/reload`.
...
**And a bug the run found ([#24](https://github.com/HeKuToCbI4/quest-together-forever-wow-addon/issues/24)).**
